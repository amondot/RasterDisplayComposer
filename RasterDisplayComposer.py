 ...
 ***************************************************************************/
"""
from qgis.PyQt.QtCore import QSettings, QTranslator, QCoreApplication, Qt, QDir
...
logger = logging.getLogger("RasterDisplayComposer")
...
class RasterDisplayComposer:
    ...
    def initGui(self):
        ...
        self.add_action(
            icon_path,
            text=self.tr(u'RasterDisplayComposer'),
            callback=self.run,
            parent=self.iface.mainWindow())

        QgsProject.instance().layersAdded.connect(self.updateLoadedrasterLayers)
        QgsProject.instance().layerWillBeRemoved.connect(self.updateLoadedrasterLayers)
    ...
    def loadRGBImage(self):
        ...
        if self.dockwidget.checkBox_save.isChecked():
            ...
            if rasterToLoad:
                ...
                rasterToLoad = '\'' + str(ET.tostring(root_vrt)) + '\''
        else:
            rasterToLoad = '\'' + str(ET.tostring(root_vrt)) + '\''
        ...
        QgsProject.instance().instance().addMapLayer(rasterLayer)
